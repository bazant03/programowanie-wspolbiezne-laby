...
void Lotnisko::zajmijPas() {
    semafor.czekaj();
}

void Lotnisko::zwolnijPas() {
    semafor.sygnalizuj();
}

void Lotnisko::zajmijHangar() {
    hangar.zajmijHangar();
}

void Lotnisko::zwolnijHangar() {
    hangar.zwolnijHangar();
}
